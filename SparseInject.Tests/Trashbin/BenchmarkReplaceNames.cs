...
namespace Trashbin
{
    ...
    public class BenchmarkReplaceNames
    {
        ...
        [TestCase(1, "Depth_1", "Transient", "Singleton")]
        [TestCase(2, "Depth_2", "Transient", "Singleton")]
        [TestCase(3, "Depth_3", "Transient", "Singleton")]
        [TestCase(4, "Depth_4", "Transient", "Singleton")]
        [TestCase(5, "Depth_5", "Transient", "Singleton")]
        ...
        public void ReplaceFileName(int depth, string folderName, string replaceFrom, string replaceTo)
        {
            ...
            foreach (var file in files)
            {
                ...
                if (fileName.Contains(replaceFrom))
                {
